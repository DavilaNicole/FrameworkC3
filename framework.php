...
<html lang="pt-br">
    ...
    <!-- Fixed navbar -->
        ...
        <div id="comofuncionaframework">
            <div class="container">
                <div class="row centered">
                    <br><br>
                    <h4>PROPOSTA</h4>
                    <br>
                    <p>Decide-se começar uma pesquisa científica. O primeiro passo é <b>montar o Time da Pesquisa</b>: Dono da Pesquisa, Orientador e Time Pesquisador.</p>

                    <br>
                    <p>Conforme imagem do pêndulo, serão cinco ciclos, iniciando pela Conscientização do Problema. O objetivo neste primeiro momento é construir a Visão da Pesquisa - <b><i>Qual é o problema que a construção da pesquisa visa resolver?</i></b> </p> <p>Será a Visão da Pesquisa que guiará as demais etapas.</p>

                    <br>
                    <p>No início de cada ciclo o Time da Pesquisa irá reunir-se e planejar as próximas tarefas. Para isso, busca-se do Backlog da Pesquisa as Atividades Científicas, refinando-as em tarefas menores. O <b>Encontro de Planejamento</b> tem como resultado um Backlog do Ciclo com tais tarefas.</p>    

                    <br>
                    <p>Durante um ciclo é possível que o Dono da Pesquisa e o Time Pesquisador reúnam-se com o Orientador para trocar informações sobre o andamento das tarefas.</p>
                    <br>
                    <p>Quando um ciclo é finalizado realiza-se um <b>Encontro de Revisão</b> do <b>Incremento da Pesquisa</b> gerado, com base nos <b>Critérios Científicos</b>. O objetivo é verificar o caráter científico das tarefas realizadas, elemento importante par o rigor do estudo. Caso os Critérios não sejam atendidos, o ciclo pode ser executado novamente, gerando um <b>Backlog do Ciclo</b> com novas tarefas.</p>
                    <br>
                    <p>Após a revisão, o Time da Pesquisa reúne-se para avaliar o processo científico, métodos, técnicas e procedimentos em um <b>Encontro de Retrospectiva</b>. Mudanças, adaptações ou melhorias podem ser identificadas neste momento, visando maior qualidade da pesquisa. Neste momento também são extraídas as heurísticas e aprendizagens obtidas no ciclo, informações importantes ao destacar as contribuições do estudo.</p>
                ...
                <div class="row centered">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td rowspan="10">Proposta de Solução</td><td>Genérica</td><td>Formalizar hipóteses</td>
                            </tr>
                            <tr>
        ...
        <div id="criteriosCientificas">
            <div class="container">
                <div class="row centered">
                    <h1>Critérios Científicas</h1>
                    <p>Itens para avaliar Incremento da Pesquisa no final de cada ciclo</p>            
                    <table class="table table-bordered">
                        <thead>
                            <tr>
